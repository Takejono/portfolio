jQuery(document).ready(function (s) {
  ...
  function l(e) {
    ...
    if (e.parents(".cd-headline").hasClass("type")) {
      ...
      }(e.find("i").eq(0), e, d, lettersDelay), o(i.find("i").eq(0), i, d, lettersDelay)
    } else e.parents(".cd-headline").hasClass("clip") ? e.parents(".cd-words-wrapper").animate({
      width: "2px"
    }, n, function () {
      h(e, i), r(i)
    }) : e.parents(".cd-headline").hasClass("loading-bar") ? (e.parents(".cd-words-wrapper").removeClass("is-loading"), h(e, i), setTimeout(function () {
      l(i)
    }, barAnimationDelay), setTimeout(function () {
      e.parents(".cd-words-wrapper").addClass("is-loading")
    }, barWaiting)) : (h(e, i), setTimeout(function () {
      l(i)
    }, t))
  }

  function r(s, e) {
    s.parents(".cd-headline").hasClass("type") ? (o(s.find("i").eq(0), s, !1, e), s.addClass("is-visible").removeClass("is-hidden")) : s.parents(".cd-headline").hasClass("clip") && s.parents(".cd-words-wrapper").animate({
      width: s.width() + 10
    }, n, function () {
      setTimeout(function () {
        l(s)
  ...
  s(".cd-headline.letters").find("b").each(function () {
    ...
    var e = s(this);
    if (e.hasClass("loading-bar")) a = barAnimationDelay, setTimeout(function () {
